...
export default function Chronology() {
    return (
        <div className="template relative flex flex-col justify-center items-center pt-0">
            <SubTitle>EDUCATION & EXPERIENCE</SubTitle>
            <div className="absolute top-20 left-1/2 -translate-x-1/2 w-px h-620 bg-main mb-20" />
