...
export const PRINCIPLES = [
    {
        ...
        body: `반복해야 하는 일은 한 번에 원하는 결과만 얻도록 자동화합니다.
원하는 서비스나 기능이 없으면 직접 만듭니다.
불편을 감수하며 익숙해지기보단 그 일을 대신할 것을 만드는 편이 효율적이기 때문입니다.`,
        proof: "서비스 · 프레임워크 · 테마",
    },
    {
        no: "02",
        ...
        emphasis: "의도된 디테일",
        body: `좋은 UX는 플로우와 UI의 작은 디테일에서 나옵니다.
좋은 UX에서 완성도가 나오고 서비스의 신뢰도를 결정한다고 생각합니다.
그래서 사용자가 인식하지 못하는 지점까지 의도를 담아 개발합니다.`,
    ...
    },
    {
        ...
        body: `AI는 개발자가 다룰 수 있는 범위와 개발 속도를 크게 넓혀주었습니다.
그래도 여전히 결과물의 검증과 판단은 결국 사람의 몫입니다.
기준을 먼저 문서로 정해두고 결과물의 부족한 지점을 직접 짚어 다듬습니다.`,
        proof: "코드 컨벤션 문서화",
    },
] as const;
